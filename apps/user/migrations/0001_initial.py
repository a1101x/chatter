# Generated by Django 2.0.3 on 2018-03-12 12:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='email_code', serialize=False, to=settings.AUTH_USER_MODEL, verbose_name='User')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='code', serialize=False, to=settings.AUTH_USER_MODEL, verbose_name='User')),
                ('code', models.CharField(db_index=True, max_length=4, verbose_name='Code')),
                ('time_expired', models.DateTimeField(db_index=True, default=apps.user.utils.default_time_expired, verbose_name='Time expired')),
            ],
        ),
